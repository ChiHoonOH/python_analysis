...
# 교차 검증한다.
score1 = cross_val_score(clf1, train_data, target, cv=k_fold, scoring='accuracy')
score2 = cross_val_score(clf2, train_data, target, cv=k_fold, scoring='accuracy')
score3 = cross_val_score(clf3, train_data, target, cv=k_fold, scoring='accuracy')
score4 = cross_val_score(clf4, train_data, target, cv=k_fold, scoring='accuracy')
score5 = cross_val_score(clf5, train_data, target, cv=k_fold, scoring='accuracy')
score6 = cross_val_score(clf6, train_data, target, cv=k_fold, scoring='accuracy')
...
test_data1 = test.loc[:, test.columns != 'PassengerId']
